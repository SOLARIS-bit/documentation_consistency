...
- **GitHub Integration**: Direct GitHub repository analysis without manual uploads
...
### GitHub Repository Direct Analysis

```python
from analyzer.github_analyzer import GitHubAnalyzer
...
For direct GitHub repo analysis:
```bash
...
result = analyzer.analyze_repository("torvalds/linux")
...
- GitHub cloning adds network latency
...
- **v2.0** (Jan 2026): Added Mermaid diagrams, GitHub integration, improved logging
